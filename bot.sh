...
while :; do
	...
	[ "$orank" != "$rank" ] && (dunstify "he is ${rank} now. copied the command" && echo "!settitle hello 👋 it is me 😊 the ${rank} best beat saber player 😎 please come watch my stream 🥺" | xclip -sel clip)
done
